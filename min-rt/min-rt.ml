...
(* solver : 
   ��ŝ����吾�с�壔�� (��� index) �����������壔����� L, P ������������������
   ��雁�� Lt + P ��������ŝ����吾�с�壔�������勌困��鴻��羆����������
   篋ょ�鴻����ŝ����翫����� 0 ������篋ょ�鴻����������翫����壔�����篁ュ�����菴�������
   �����勤�������ゃ�� nvector ��т困��鴻�勖��膩������壔����˨��羆�������������綽�荀����
   (��贋�剛����勐�翫��)

   篋ょ�鴻�勐婚罔���� t ��勐�ゃ�������� solver_dist �����主��������������
*)
...
(*NOMINCAML let rec shadow_check_one_or_matrix ofs or_matrix p =*)
  ...
  if range_primitive = -1 then false (* OR茵������勛��篋������若�� *)
  else (
...
(*NOMINCAML let rec solve_each_element iand_ofs and_group =*)
  ...
  if iobj = -1 then ()
    ...
    if t0 <> 0 then
      (
        (* 篋ょ�鴻�������������壔�������勌困��鴻��篁���勤��膣���勌賢�����˨�障����������í�����茯帥�鴻�����*)
        (* 篁���障�с�勌賢��ф��絨���� t ��勐�ゃ��罸���鴻�����*)
       let t0p = solver_dist.(0) in
       if -0.1 < t0p then
         if t0p < tmin.(0) then
           (
...
(**** �����㋘�若�号�㋙�� ****)
(* �����㋘�若�拷��紮���� ViewPoint �����������勛�鴻�������勉�鴻�㏍�ｃ�恰�劫�������壔����� *)
(* Vscan ���������篋ょ�� crashed_point ��◑��腦���������ŝ����吾�с�壔��         *)
(* crashed_object ���菴���������∽�域�ŭ����勤�������ゃ�壚困��鴻�勖����＜�勛����遵�ゃ�� *)
...
(*NOMINCAML let rec raytracing nref energy =*)
  ...
  if crashed_p then
    ...
    ( 
      ...
      in
      utexture cobj crashed_point; (* �����壔�鴻����ｃ��荐�膊� *)
